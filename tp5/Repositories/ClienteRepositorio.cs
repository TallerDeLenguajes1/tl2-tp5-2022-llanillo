...
{
    public ClienteRepositorio(string cadenaConexion) : base(cadenaConexion)
    {
    }
    ...
    public override Cliente BuscarPorId(int id)
    {
        ...
        {
            Console.WriteLine("Error al buscar el cliente: " + id);
        }
    ...
    public override IEnumerable<Cliente> BuscarTodos()
    {
        ...
        {
            Console.WriteLine("Error al buscar todos los clientes");
        }
    ...
    public override void Insertar(Cliente entidad)
    {
        ...
        {
            Console.WriteLine("Error al insertar el cliente: " + entidad.Nombre);
        }
    }
    ...
    public override void Eliminar(int id)
    {
        ...
        {
            Console.WriteLine("Error al eliminar el cliente: " + id);
        }
    }
}